...
export const GENS: VersionType[][] = [
    [
        {label: 'Rouge', value: 'red', color: '#be0d0d'},
        {label: 'Bleu', value: 'blue', color: '#1E4B89'},
        {label: 'Jaune', value: 'yellow', color: '#EFBF43'}
    ],
    [
        {label: 'Or', value: 'gold', color: '#cbbe1e'},
        {label: 'Argent', value: 'silver', color: '#87868B'},
        {label: 'Cristal', value: 'crystal', color: '#359eaf'}
    ],
    [
        {label: 'Rubis', value: 'ruby', color: '#b63134'},
        {label: 'Saphir', value: 'sapphire', color: '#274388'},
        {label: 'Emeraude', value: 'emerald', color: '#15b758'}
    ],
    [
